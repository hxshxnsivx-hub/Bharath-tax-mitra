/**
 * Tabs — design-system primitive (OPT-UI.1, shadcn/ui copy-in on Radix).
 * Keyboard-navigable, aria-correct tab sets. Intended consumers: the
 * old/new regime toggle (RegimeComparison) and settings sections.
 */
